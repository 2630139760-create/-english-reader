(() => {
  ...
  const ui = Object.fromEntries([
    "openOcrButton", "ocrModal", "ocrBackdrop", "ocrPanel", "ocrClose", "ocrFile", "ocrFileName", "ocrStatus",
  ...
  [ui.ocrClose, ui.ocrCancel].forEach((element) => element.addEventListener("click", closePanel));
  ui.ocrModal.addEventListener("click", (event) => { if (event.target === ui.ocrBackdrop) closePanel(); });
